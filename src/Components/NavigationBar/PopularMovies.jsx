    ...
    <>
      <InputFields>
        ...
        <Input
          ...
          onKeyDown={(e) => {
            if (e.key === "Enter") setMoviename(e.target.value);
          }}
          placeholder="movie name"
          id="searchText"
        />
        {moviename !== "" && movielistsearch.isLoading && <div class="loader"></div>}
      </InputFields>

      {moviename !== "" ? (
        movielistsearch.error ? (
          <p>Error: {movielistsearch.error.message}</p>
          ...
          !movielistsearch.isLoading && <p>No movies found.</p>
        )
      ) : (
        <>
          <InputFields>
